...
class Neighborhoods(models.Model):
    ...
    r5 = models.ForeignKey(Restaurants, related_name='Restaurant5', on_delete=models.CASCADE)
    r6 = models.ForeignKey(Restaurants, related_name='Restaurant6', on_delete=models.CASCADE)
    r7 = models.ForeignKey(Restaurants, related_name='Restaurant7', on_delete=models.CASCADE)
    r8 = models.ForeignKey(Restaurants, related_name='Restaurant8', on_delete=models.CASCADE)
    r9 = models.ForeignKey(Restaurants, related_name='Restaurant9', on_delete=models.CASCADE)
    r10 = models.ForeignKey(Restaurants, related_name='Restaurant10', on_delete=models.CASCADE)
